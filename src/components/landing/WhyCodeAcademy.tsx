...
export const WhyCodeAcademy = () => {
  const advantages = [
    ...
    {
      icon: <Trophy className="h-12 w-12 text-blue-800" />,
    ...
    <section className="py-20 bg-slate-50">
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mt-16">
          <div className="bg-white rounded-2xl p-8 blue-shadow-lg border border-blue-100 max-w-2xl mx-auto">
            <div className="blue-gradient-1 rounded-xl p-6 mb-6">
